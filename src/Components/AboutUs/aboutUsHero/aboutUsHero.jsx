...
const AboutHeroSection = () => {
  ...
  return (
    <>
        ...
        <div className="bg-darkgreen">
          <div className="container">
            <div className="linebg1 py-[100px] relative">
              ...
              <div className="row align-center mt-md-0 mt-3 pt-75 relative pl-0 md:pl-32 pr-0 md:pr-24">
      ...
      <section className="text-center">
        <div className="container">
          <div className="linebg1 py-[100px] relative">
            ...
            <div className="row flex md:items-center relative pl-0 md:pl-32 pr-0 md:pr-32">
      ...
      <div className="container-fluid py-[100px] lightcrembg pl-28 pr-28 LeaderShip">
