      ...
      <div className="container">
        ...
        <div className="custom-padding-left-60" >
          ...
          <div className="padding-inner" >
            ...
            <h3 className="font-22 mb-2 mt-3" >
              Zendesk:
            </h3>
            <p className="font-18" >
        ...
        <h2 className="font-26 mb-1 mt-md-5 mt-3" >
        ...
        <ul className="list-unstyled mt-4 mb-4" >
          <li className="font-18 d-flex gap-2 align-items-start mb-2">
            <img src={circle} className="me-2" alt="tick" />
        ...
        <h2 className="font-26 mb-md-3 mt-md-5 mt-3" >
